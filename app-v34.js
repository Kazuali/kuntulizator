...
function isExactHit(prediction, match) {
  ...
  // Точный счёт считается отдельно от прохода/исхода.
  // Пример плей-офф: факт 1-1 Бразилия, прогноз 1-1 Япония =>
  // участник получает банк точного счёта, но не получает банк прохода.
  return prediction.home === match.homeScore && prediction.away === match.awayScore;
}
